        ...
        <>
            <section class="bg-center bg-no-repeat bg-[url('https://wallpapercave.com/wp/wp8547031.jpg')] bg-gray-700 bg-blend-multiply">
                <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
                    ...
                    {selectedCategory ? (
                        <>
                            <button className="inline-flex justify-center hover:text-gray-900 items-center py-3 px-5 sm:ms-4 text-base font-medium text-center text-white rounded-lg border border-white hover:bg-gray-100 focus:ring-4 focus:ring-gray-400 mb-5" onClick={handleBackButtonClick}>Back</button>
